...
import { Navbar, Accordion, Container, Row, Jumbotron, Button, Image, Modal, Carousel, Card} from "react-bootstrap";
...
class MainSite extends Component {
  ...
  handleOpenGal = () => {
    this.setState({showGal: !this.state.showGal});
  }

  handleOpenMemb = () => {
    this.setState({showMemb: !this.state.showMemb});
  }
    ...
    return(
      <Container>
            ...
            <Row className="justify-content-center">
              ...
              <Button className="uniBtn" variant="primary" onClick={() => this.handleOpenJoin()}>About Us</Button>
              <Button className="uniBtn" variant="primary" onClick={() => this.handleOpenMemb()}>Members</Button>
              <Button className="uniBtn" variant="primary" onClick={() => this.handleOpenRules()}>Policies</Button>
              <Button className="uniBtn" variant="primary" onClick={() => this.handleOpenGal()}>Gallery</Button>
              <Button className="uniBtn" variant="primary" onClick={() => this.handleOpenEvent()}>Current Events</Button>
          </Row>
            </Accordion.Collapse>
            </div>
            </Accordion>
  ...
  currentEventModal() {
    if(this.state.showEvent == true) {
      return(
        <div>
          <Modal show={this.state.showEvent} onHide={this.handleOpenEvent}>
            <Modal.Header className="noviModalHead" closeButton>Current Events!</Modal.Header>
            <Modal.Body className="noviModalHead">
                {this.currentEventsText()}
            </Modal.Body>
          </Modal>
        </div>
      );
  ...
  openJoinUsModal() {
    if(this.state.showJoin == true) {
      return (
        <div>
          <Modal show={this.state.showJoin} onHide={this.handleOpenJoin}>
  ...
  openGalModal() {
    if(this.state.showGal == true) {
      return (
        <div>
          <Modal show={this.state.showGal} onHide={this.handleOpenGal} size="lg">
  ...
  openRulesModal() {
    if(this.state.showRules == true) {
      return (
        <div>
          <Modal show={this.state.showRules} onHide={this.handleOpenRules} size="lg">
  ...
  openMembModal() {
    if(this.state.showMemb == true) {
      return (
        <div>
          <Modal show={this.state.showMemb} onHide={this.handleOpenMemb} size="lg">
